...
public class DSArrayList {
  ...
  public static void main(String[] args) {
    ...
    // Mit der folgenden Zeile deklarieren wir eine ArrayList Liste und legen eine Datenstruktur fest, in der alles
    ...
    // Wenn wir in unserer ArrayList nur Namen speichern wollen, müssen wir mit Generics einen Datentyp festlegen.
    ...
    // einkaufsListe.add(new Integer(4)); // Hmmm, eine Ganzzahl in einer Einkaufsliste passt nicht.
